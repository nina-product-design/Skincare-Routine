...
export default function Locked({ className }: { className?: string }) {
  return (
    <div className={className || "bg-[#f9f7f2] content-stretch flex flex-col items-center overflow-clip relative rounded-[10px] w-[327px]"} data-name="Locked">
          ...
          <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[8px] relative w-full">
            ...
            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
              <p className="font-['Simplon_Norm:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#161716] text-[#6c6c6c] text-[0px] text-[12px] tracking-[0.24px] w-full whitespace-pre-wrap">
                <span className="font-['Simplon_Norm:Medium',sans-serif] leading-[1.5]">{`You have subscribed to 0 of 3 items `}</span>
