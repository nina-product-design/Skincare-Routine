      ...
      <div className="bg-[#e2d9c2] h-[27px] relative shrink-0 w-full">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[4px] py-[9px] relative size-full">
            <p className="flex-[1_0_0] font-['Simplon_Mono:Medium',sans-serif] leading-[1.2] min-h-px min-w-px not-italic relative text-[#161716] text-[12px] text-center tracking-[0.96px] uppercase">Subscribe to 3 items to unlock</p>
          </div>
        </div>
      </div>
          ...
          <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[8px] relative w-full">
            ...
            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
              <p className="font-['Simplon_Norm:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6c6c6c] text-[0px] text-[12px] tracking-[0.24px] w-full whitespace-pre-wrap">
                ...
                <span className="font-['Simplon_Norm:Medium',sans-serif] leading-[1.5]">{`0 of 3 items `}</span>
                <span className="leading-[1.5]">
